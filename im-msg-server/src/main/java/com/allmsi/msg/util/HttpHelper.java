        ...
        try {
            ...
            if (entity != null) {
                ...
                if (result.getInteger("errcode") == 0) {
                    ...
                    System.err.println("request url=" + url + ",return value=");
            ...
            System.err.println("request url=" + url + ", exception, msg=" + e.getMessage());
            e.printStackTrace();
        } finally {
        ...
        try {
            ...
            if (entity != null) {
                ...
                if (result.getInteger("errcode") == 0) {
                    ...
                    System.err.println("errcode= "+result.getInteger("errcode")+",request url=" + url + ",return value=");
                    int errCode = result.getInteger("errcode");
                    String errMsg = result.getString("errmsg");
                    throw new OApiException(errCode, errMsg);
                }
